...
<!--			<div id="site_title"><h1><a rel="nofollow" href="http://www.tooplate.com">Free Website Templates</a></h1></div>
		...
		<div id="tooplate_menu">
			<ul>
				...
				<li><a href="registraction.jsp" class="current">register</a></li>
<!--				<li><a href="news.html">News</a></li>
	...
	<section id="content">
			...
			<h1>Login Form</h1>
			<div>
                            <img src="images1/user3.png" alt="Image 03" width="200" height="150"/>
                            <input type="text" placeholder="EMAILID" required="" name="emailid" id="password" />
			</div>
			<div>
