...
<!--				<li><a href="news.html">News</a></li>
		...
		<div id="tooplate_main" style="background-image: url(images1/pa.jpg)"><span class="tm_top"></span>
                    ...
                    <div align="center" color="red">
                        ...
                        InputStream n1 = null;
                        String logo = null;
                        String place2 = null, de2=null,rate2=null;
...
//                        session.setAttribute("uploadId",uploadId);
                        ...
                        while (rs.next()){
                            ...
                            de2=rs.getString("de2");
                            rate2=rs.getString("rate2");
                            
                            
                      %>
                    <div><img src="viewimage22.jsp?id=<%=id%>" alt="" width="350" height="250" /></div>
                    <center><div class="CSSTableGenerator" >
            <table width="300" >
                <tr><td> place</td><td> <%=place2%></td></tr>
                <tr><td> DESCRIPTION</td><td> <%=de2%></td></tr>
                <tr><td> RATINGS</td><td> <%=rate2%></td></tr>
                </table>
                <div>
