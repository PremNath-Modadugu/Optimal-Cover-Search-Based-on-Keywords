...
<!--				<li><a href="blog.html">Blog</a></li>
		...
		<div id="tooplate_main" style="background-image: url(images1/pa.jpg)"  ><span class="tm_top"></span>
                     ...
                     <form name="form" action="upload.jsp" method="get" onSubmit="return validation();">   
                    <div align="center" color="red">
                        <center><font color="RED"><h1> UPLOAD</font></h1><center>
                            <table>
                                <tr>
                                        <td style="color:salmon"> KEYWORD</td>
                                        <td><input type="text" name="keyword" id="user" style="margin-left: 10px;width: 250px;height: 20px;font-size: 15px;border-radius: 5px;background-color: bisque;color: black"/>
                                            
                                        </td>
                                    </tr>
                                <tr>
                                        <td style="color:salmon">LOCATION </td>
                                        <td><input type="text" name="location" id="user" style="margin-left: 10px;width: 250px;height: 20px;font-size: 15px;border-radius: 5px;background-color: bisque;color: black"/>
                                            
                                        </td>
                                    </tr>
                                <tr>
                                        <td style="color:salmon"> SUB KEY</td>
                                        <td><input type="text" name="keyname" id="user" style="margin-left: 10px;width: 250px;height: 20px;font-size: 15px;border-radius: 5px;background-color: bisque;color: black"/>
                                            
                                        </td>
                                    </tr>
                                <tr>
                                        <td style="color:salmon"> DESCRIPTION</td>
                                        <td><input type="text" name="desc"  id="user" style="margin-left: 10px;width: 250px;height: 20px;font-size: 15px;border-radius: 5px;background-color: bisque;color: black"/>
