...
<!--				<li><a href="news.html">News</a></li>
		...
		<div id="tooplate_main" style="background-image: url(images1/pa.jpg)"><span class="tm_top"></span>
                    ...
                    <div align="center" color="red">
                        <center><h1> VIEW IMAGE DETAILS</h1><center>
                            <%
...
//                        session.setAttribute("uploadId",uploadId);
                        ...
                        while (rs.next()){
                            place1=rs.getString("place6");
                            de1=rs.getString("de6");
                            rate1=rs.getString("rate6");
                            
                            
                      %>
                    <div><img src="viewimage26.jsp?id=<%=id%>" alt="" width="350" height="250" /></div>
            ...
            <table width="300" >
                ...
                <div>
                            ...
                            <input type="submit" name="submit" value="my suggesion"style="width: 150px;height: 30px;font-size: 20px;border-radius: 30px;background-color: pink;color: red"/><br><br><br>
