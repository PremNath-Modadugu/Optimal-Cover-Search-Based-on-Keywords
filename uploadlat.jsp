...
<!--			<div id="site_title"><h1><a rel="nofollow" href="http://www.tooplate.com">Free Website Templates</a></h1></div>
		...
		<div id="tooplate_main" style="background-image: url(images1/pa.jpg)"><span class="tm_top" ></span>
                    <div align="center">
                        <div id="o"><table>
                                <tr>
                                    <td><font color=brown>latitude</td></font><td><input size="10" type="text" id="latbox" name="lat1" value="" style="margin-left: 5px;width: 200px;height: 25px;font-size: 15px;border-radius: 5px;background-color: bisque;color: red"><font color="brown">longitude</font><input size="10" type="text" id="latbox" name="long1" value="" style="margin-left: 5px;width: 200px;height: 25px;font-size: 15px;border-radius: 5px;background-color: bisque;color: red"/><font color="brown">place</font><input size="10" type="text" id="latbox" name="lat" value="" style="margin-left: 5px;width: 200px;height: 25px;font-size: 15px;border-radius: 5px;background-color: bisque;color: red"></td>
                                </tr>
                                <tr>
                                    <td><font color="red">other</font></td>
                                </tr>
                                <tr>
                                    <td><font color=brown>latitude</td></font><td><input size="10" type="text" id="latbox" name="lat2" value="" style="margin-left: 5px;width: 200px;height: 25px;font-size: 15px;border-radius: 5px;background-color: bisque;color: red"><font color="brown">longitude</font><input size="10" type="text" id="latbox" name="long2" value="" style="margin-left: 5px;width: 200px;height: 25px;font-size: 15px;border-radius: 5px;background-color: bisque;color: red"/><font color="brown">place</font><input size="10" type="text" id="latbox" name="lat" value="" style="margin-left: 5px;width: 200px;height: 25px;font-size: 15px;border-radius: 5px;background-color: bisque;color: red"></td>
                                </tr>
                                <tr>
                                    <td><font color=brown>latitude</td></font><td><input size="10" type="text" id="latbox" name="lat3" value="" style="margin-left: 5px;width: 200px;height: 25px;font-size: 15px;border-radius: 5px;background-color: bisque;color: red"><font color="brown">longitude</font><input size="10" type="text" id="latbox" name="long3" value="" style="margin-left: 5px;width: 200px;height: 25px;font-size: 15px;border-radius: 5px;background-color: bisque;color: red"/><font color="brown">place</font><input size="10" type="text" id="latbox" name="lat" value="" style="margin-left: 5px;width: 200px;height: 25px;font-size: 15px;border-radius: 5px;background-color: bisque;color: red"></td>
                                </tr>
                                <tr>
                                    <td><font color=brown>latitude</td></font><td><input size="10" type="text" id="latbox" name="lat4" value="" style="margin-left: 5px;width: 200px;height: 25px;font-size: 15px;border-radius: 5px;background-color: bisque;color: red"><font color="brown">longitude</font><input size="10" type="text" id="latbox" name="long4" value="" style="margin-left: 5px;width: 200px;height: 25px;font-size: 15px;border-radius: 5px;background-color: bisque;color: red"/><font color="brown">place</font><input size="10" type="text" id="latbox" name="lat" value="" style="margin-left: 5px;width: 200px;height: 25px;font-size: 15px;border-radius: 5px;background-color: bisque;color: red"></td>
                                </tr>
                                <tr>
                                    <td><font color=brown>latitude</td></font><td><input size="10" type="text" id="latbox" name="lat5" value="" style="margin-left: 5px;width: 200px;height: 25px;font-size: 15px;border-radius: 5px;background-color: bisque;color: red"><font color="brown">longitude</font><input size="10" type="text" id="latbox" name="long5" value="" style="margin-left: 5px;width: 200px;height: 25px;font-size: 15px;border-radius: 5px;background-color: bisque;color: red"/><font color="brown">place</font><input size="10" type="text" id="latbox" name="lat" value="" style="margin-left: 5px;width: 200px;height: 25px;font-size: 15px;border-radius: 5px;background-color: bisque;color: red"></td>
                                </tr>
                                <tr>
                                    <td><font color=brown>latitude</td></font><td><input size="10" type="text" id="latbox" name="lat6" value="" style="margin-left: 5px;width: 200px;height: 25px;font-size: 15px;border-radius: 5px;background-color: bisque;color: red"><font color="brown">longitude</font><input size="10" type="text" id="latbox" name="long6" value="" style="margin-left: 5px;width: 200px;height: 25px;font-size: 15px;border-radius: 5px;background-color: bisque;color: red"/><font color="brown">place</font><input size="10" type="text" id="latbox" name="lat" value="" style="margin-left: 5px;width: 200px;height: 25px;font-size: 15px;border-radius: 5px;background-color: bisque;color: red"></td>
                                </tr>
                            </table>
<div id="content">
...
<form onsubmit="showAddress(this.address.value); return false;">
    <div style="text-align:center;font-size:1.1em;"><strong><font COLOR=brown FACE=",Arial" SIZE=3>Address:</font></strong> <input type="text" style="width:300px;font-size:1.1em;border-radius: 5px;background-color: bisque;color: red" name="address" value="123 Street, City State/Country" onfocus="if (this.value == '123 Street, City State/Country'){this.value='';} "> <input type="submit" style="font-size:100%" value=" GO "></div>
</form>
</td>
</tr>
</table>
...
<table width="100%">
    <tr><td style="color:brown;font-size: 15px"><font COLOR=brown FACE="Geneva, Arial" SIZE=3>Latitude:</font></td><td colspan="3"><input size="10" type="text" id="latbox" name="lat" value="" style="margin-left: 5px;width: 250px;height: 25px;font-size: 15px;border-radius: 5px;background-color: bisque;color: red"></td><td ><FONT COLOR=brown FACE="Geneva, Arial" SIZE=3>Longitude:</font></td><td colspan="3"><input size="10" type="text" id="lonbox" name="lon" value=""style="margin-left: 5px;width: 250px;height: 25px;font-size: 15px;border-radius: 5px;background-color: bisque;color: red" ></td></tr>
<tr></tr>
...
<tr style="display:none"><td>Latitude:</td><td><input size="3" type="hidden" id="latboxm" name="latm" value=""style="margin-left: 100px;width: 250px;height: 20px;font-size: 15px;border-radius: 5px;background-color: bisque;color: red" ></td><td><input size="6" type="text" id="latboxmd" name="latmd" value="" ></td><td><input size="8" type="text" id="latboxms" name="latms" value="" ></td></tr>
<tr style="display:none"><td >Longitude:</td><td><input size="3" type="hidden" id="lonboxm" name="lonm" value="" ></td><td><input size="6" type="text" id="lonboxmd" name="lonmd" value="" ></td><td><input size="8" type="text" id="lonboxms" name="lonms" value="" ></td></tr>
</table>
<%
...
<div id="wrapper" style="margin:5px"><div id="map" style="width: 650px; height: 450px"></div></div>
</td>
