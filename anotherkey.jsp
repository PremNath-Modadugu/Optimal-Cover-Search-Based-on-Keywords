		...
		<div id="tooplate_middle_subpage">
			<marquee scrollamount="15"> <img src="images1/image11.jpg" alt="Image 03" width="200" height="150"/>
                ...
                <div id="tooplate_main" style="background-image: url(images1/pa.jpg)"><span class="tm_top"></span>
                    ...
                    <center><h1> <font color="brown">  PLEASE TRY ANOTHER KEY </font></h1></center>
                    <center> <input type="submit" value="BACK" placeholder="Type Here" style="margin-left: 100px;width: 100px;height: 30px;font-size: 20px;border-radius: 30px;background-color: pink;color: red"/></center>
                    </form>
